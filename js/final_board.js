...
document.querySelector('.icon_pint').addEventListener('click', () => {
        ...
        if (/image\/*/.test(event.target.files[0].type)) {
            ...
            reader.onload = function () {
                ...
                new_image.onload = function () {
                    ...
                    document.querySelector('.img_upload_container').style.display = 'none';
...
document.querySelector('.pin_save').addEventListener('click', () => {
    const users_data = {
        author: 'Jack',
        board: 'default',
        title: document.querySelector('#new_pin_input').value,
...
function create_pin(pin_details) {
    ...
    new_image.onload = function () {
        ...
        new_pin.innerHTML = `<div class="title_pin">${pin_details.title}</div>
<div class="pin_modal">
    ...
    <div class="modal_foot">
        <div class="destination">
            <div class="icon_pint_container">
                <img src="../images/icons/arrow.png" alt="destination" class="icon_pint">
            </div>
            <span>${pin_details.destination}</span>
        </div>
        <div class="pint_mock_icon_container">
            <img src="../images/icons/send.png" alt="send" class="pint_mock_icon">
        </div>
        <div class="pint_mock_icon_container">
            <img src="../images/icons/ellipse.png" alt="edit" class="pint_mock_icon">
        </div>
    </div>
</div>
<div class="pin_image">
